          ...
          showTodoWithDetails:{
           ...
           _:{
            ...
            defaultValue:0
                  ...
                  todos(
                    first: 2147483647  # max GraphQLInt , if you have extra search field, remember to add 'filters' filed in your @connection , 
                                       # if you don't do that, it default to all variables used. see @miracle2k 's comment
